...
<body>
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <a href="dashboard.jsp" class="text-white active">Dashboard</a>
	<a href="add_train_form.jsp">Add Train</a>
	<a href="add_train_fare.jsp">Add Train Fare</a>
	<a href="passenger_list.jsp">Passenger Details</a>
	<a href="logout.jsp">
	  ...
	  <h1 class="m-auto text-center"> Train Information </h1>
<%
...
<div class="container float-end w-25">
	<input type="text" name="" id="search" onkeyup="searchFun()" class="rounded-4" placeholder="Search Train .....">
</div>
